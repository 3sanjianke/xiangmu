...
<html>
	<head>
		<meta charset="utf-8" />
		<title>后台主页</title>
		<link href="${APP_PATH}/css/Site.css" rel="stylesheet" type="text/css" />
		<link href="${APP_PATH }/css/zy.layout.css" rel="stylesheet" />
		<link href="${APP_PATH }/css/zy.form.css" rel="stylesheet" />
		...
		<style type="text/css">
			...
			.headeruserface {
				background-image: url('${APP_PATH}/Resources/images/logo.png');
				width: 40px;
				height: 40px;
				background-color: white;
		...
		<link href="${APP_PATH }/css/zy.menu.css" rel="stylesheet" />
	</head>
	<body>
		<div class="dvheader">
		...
		<div class="dvcontent">
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="${APP_PATH }/fenlei/top.do" target="right">
							<li>分类管理</li>
						</a>
						<a href="${APP_PATH }/kucun/main.do" target="right">
							<li>库存管理</li>
						</a>
						<a href="${APP_PATH }/ruku/main.do" target="right">
							<li>入库管理</li>
						</a>
						<a href="${APP_PATH }/yujin/main.do" target="right">
							<li>预警信息设置</li>
						</a>
			...
			<div style="position: absolute; left: 181px; right: 20px; ">
			     <iframe  src="${APP_PATH }/fenlei/top.do" scrolling="no"  width="100%" height="720" name="right" border="none"></iframe> 
			 
			</div>
		</div>
		<script src="${APP_PATH }/js/jquery-1.7.2.min.js" type="text/javascript"></script>
		<script src="${APP_PATH }/js/plugs/Jqueryplugs.js" type="text/javascript"></script>
		<script src="${APP_PATH }/js/_layout.js"></script>
	</body>
</html>