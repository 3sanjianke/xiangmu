	...
	<div id="list">
		 ...
		 <div class="list_info">
			 ...
			 <table class="regTable">
				...
				<tr>
					<td align="right" width="20%"><span style="color:red">*</span> 性　别：</td>
				...
				<tr>
					<td align="right" width="20%">用户地址：</td>
					<td align="left" width="80%"><input type="text" name="user_address" id="user_address" style="width:200px;" class="inputstyle"/></td>
				</tr>
				<tr>
					<td align="right" width="20%">用户邮箱：</td>
