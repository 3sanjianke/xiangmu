	 ...
	 <div id="product_info">
			...
			<div class="list">
					<div class="sign" style="background:none;text-align:right">
				      ...
				      <select id="goods_type_id" name="goods_type_id" class="inputstyle" style="width:100px;">
				      	...
				      	<option value="${goodsType.goods_type_id}" ${goodsType.goods_type_id==paramsGoods.goods_type_id?'selected':''}>${goodsType.goods_type_name}</option>
				            ...
				            价格范围：
				      <input type="text" id="goods_price_min" name="goods_price_min" value="${paramsGoods.goods_price_min}" class="inputstyle" Style="width:50px;"/>
				      &nbsp;-&nbsp;
				      <input type="text" id="goods_price_max" name="goods_price_max" value="${paramsGoods.goods_price_max}" class="inputstyle" Style="width:50px;"/>&nbsp;
					...
					<div class="product">
						...
						<div class="productText"><span class="title">${fn:length(goods.goods_name)>11?fn:substring(goods.goods_name,0,10):goods.goods_name}..</span>
						<br/>￥${goods.goods_price} 元/天
						<br/>物品类别：${goods.goods_type_name}
						</div>
					</div>
					</c:forEach>
   					</c:if>
