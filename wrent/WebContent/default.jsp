...
<script language="javascript" type="text/javascript"> 
	...
	var configtg='0xffffff|1|0xadb96e|6|0xffffff|0xC5DDBC|0x000033|4|3|1|_blank';
	var files = '';   
	var links = '';
	var texts = '';   
	files='images/hdtp/1.jpg|images/hdtp/2.jpg|images/hdtp/3.jpg|images/hdtp/4.jpg';
	links='|||';
	texts='婚庆用品租赁系统展示1……|婚庆用品租赁系统展示2……|婚庆用品租赁系统展示3……|婚庆用品租赁系统展示4';
					...
					<div>
						<div class="info_text">
							<a href="page_queryGoods.action?goods_id=${goods.goods_id}" target="_blank" title="${goods.goods_name}">
								${fn:length(goods.goods_name)>25?fn:substring(goods.goods_name,0,24):goods.goods_name}..
							</a>
						</div>
				...
				<c:forEach items="${goodss2}" var="goods" varStatus="status">
				  <li>
					<div>
						...
						<div class="info_time">[租赁：${goods.goods_sale}]</div>
					</div>
				  </li>
				  </c:forEach>
				</ul>
