...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">婚庆用品分类管理&gt;&gt;婚庆用品分类查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<a href="Admin_editGoodsType.action?goods_type_id=${goodsType.goods_type_id}">编辑</a>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${goodsTypes==null ||  fn:length(goodsTypes)==0}">
   <tr>
     <td height="60" colspan="10" align="center"><b>&lt;不存在婚庆用品分类信息&gt;</b></td>
   </tr>
   </c:if>
