...
<title>${goodsType!=null && goodsType.goods_type_id!=0?'编辑':'添加'}婚庆用品分类信息</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">婚庆用品分类管理&gt;&gt;${goodsType!=null && goodsType.goods_type_id!=0?'编辑':'添加'}婚庆用品分类</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle">${goodsType!=null && goodsType.goods_type_id!=0?'编辑':'添加'}婚庆用品分类</TD>
