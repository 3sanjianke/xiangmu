...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
	<TBODY>
		<TR>
			<TD style="font-size:38px;font-family:'黑体';text-align:center;HEIGHT:105px;">
				婚庆用品租赁系统
			</TD>
		</TR>
		<TR>
			...
			<TBODY>
				...
				<TR>
					...
					<TBODY>
						<TR>
							<TD style="HEIGHT: 25px" width=80>登 录 名：</TD>
							<TD style="HEIGHT: 25px" width=150><INPUT id="params.user_name" name="user_name" value="${params.user_name}" style="WIDTH: 130px" name=txtName></TD>
							<TD style="HEIGHT: 25px" width=370>
						...
						<TR>
							...
							<TD style="HEIGHT: 25px"><INPUT id="params.user_pass" name="user_pass"   style="WIDTH: 130px" 
							  type="password"></TD>
						...
						<TR>
							<TD style="HEIGHT: 25px">验 证 码：</TD>
							<TD style="HEIGHT: 25px">
								<INPUT id="params.random" name="random" style="WIDTH: 60px" name=txtcode>
						...
						<TR>
							<TD></TD>
							<TD colspan="2" id="loginTip" style="HEIGHT:18px;color:orange">${tip}</TD>
						</TR>
						<TR>
							<TD></TD>
							<TD><img id="loginInBtn" height="25" style="border:0px;cursor:pointer" src="images/login_button.gif" /> </TD>
						</TR>
					</TBODY>
					</TABLE>
					</TD>
