			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">物品类别管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listGoodsTypes.action" target="MainFrame">物品类别查询</a></li>
					  <li><a href="Admin_addGoodsTypeShow.action" target="MainFrame">新增物品类别</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">婚庆用品管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listGoodss.action" target="MainFrame">婚庆用品查询</a></li>
					  <li><a href="Admin_addGoodsShow.action" target="MainFrame">新增婚庆用品</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">租赁订单管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listOrderss.action" target="MainFrame">用户订单查询</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">租赁信息统计</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listOrderssSum.action" target="MainFrame">租赁信息统计</a></li>
					</ul>
				  </div>
