...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">婚庆用品管理&gt;&gt;婚庆用品查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="" align="center">类别</td>
     <td width="" align="center">租金</td>
     <td width="" align="center">日违约金</td>
     <td width="" align="center">租赁押金</td>
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">${goods.goods_yj}</td>
     ...
     <td width="" align="center">
       <a href="Admin_queryGoods.action?goods_id=${goods.goods_id}&goods_kind=1">查看</a>&nbsp;
       <a href="Admin_editGoods.action?goods_id=${goods.goods_id}&goods_kind=1">编辑</a>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${goodss==null || fn:length(goodss)==0}">
   <tr>
     <td height="60" colspan="13" align="center"><b>&lt;不存在物品信息&gt;</b></td>
   </tr>
   </c:if>
